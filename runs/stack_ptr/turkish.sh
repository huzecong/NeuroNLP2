...
CUDA_VISIBLE_DEVICES=2 python examples/StackPointerParser.py --mode FastLSTM --num_epochs 1000 --batch_size 32 --decoder_input_size 256 --hidden_size 512 --encoder_layers 3 --decoder_layers 1 \
 ...
 --word_embedding polyglot --word_path "data/polyglot/polyglot-tr.pkl" --char_embedding random \
 --punctuation 'Punc' \
 --train "data/conll2006/Turkish/turkish_metu_sabanci_train.conll" \
 --dev "data/conll2006/Turkish/turkish_metu_sabanci_dev.conll" \
 --test "data/conll2006/Turkish/turkish_metu_sabanci_test.conll" \
 --model_path "models/parsing/stack_ptr/" --model_name 'network.pt.turkish'
