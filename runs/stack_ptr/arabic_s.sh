...
CUDA_VISIBLE_DEVICES=2 $PYTHON examples/StackPointerParser.py --mode FastLSTM --num_epochs 1000 --batch_size 8 --decoder_input_size 256 --hidden_size 512 --encoder_layers 3 --decoder_layers 1 \
 ...
 --p_in 0.33 --p_out 0.33 --p_rnn 0.33 0.33 --unk_replace 0.5 --label_smooth 1.0 --pos --beam 10 --prior_order inside_out \
 --grandPar \
