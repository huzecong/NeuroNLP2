...
CUDA_VISIBLE_DEVICES=2 $PYTHON examples/StackPointerParser.py --mode FastLSTM --num_epochs 1000 --batch_size 32 --decoder_input_size 256 --hidden_size 512 --encoder_layers 3 --decoder_layers 1 \
 ...
 --word_embedding polyglot --word_path "data/polyglot/polyglot-bg.pkl" --char_embedding random \
 --punctuation 'Punct' \
 ...
 --model_path "models/parsing/stack_ptr/bulgarian_gs/" --model_name 'network.pt.bulgarian_gs'
